...
public class Yt extends BaseAppCompat {
    ...
    private boolean isPlaying, isCancelled, isPaused;
    ...
    public void onBackPressed() {
        if (youTubePlayerView != null && youTubePlayerView.isFullScreen()) {
            ...
            if (quitDiag == null) {
                ...
                quitTv.setText(getString(R.string.close_diag_desc_v));
    ...
    private void initList() {
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            if (isPlaying) {
                Toast.makeText(this, getString(R.string.yt_playing_wait), Toast.LENGTH_LONG).show();
            } else {
                if (player == null) {
                    Toast.makeText(this, getString(R.string.yt_player_not_ready), Toast.LENGTH_LONG).show();
                } else {
                    isPlaying = true;
                    position = i;
