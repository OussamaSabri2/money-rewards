...
public class GuessWord extends AppCompatActivity {
    ...
    private void callOnce() {
        ...
        GetGame.getGWInfo(GuessWord.this, new onResponse() {
            ...
            public void onSuccessHashMap(HashMap<String, String> data) {
                ...
                failedTitle.setText(getString(R.string.timeup));
                ...
                failedDesc.setText(getString(R.string.timeup_desc));
                ...
                keepTrying.setText(getString(R.string.yes));
            ...
            if (isLocked) {
                if (!isAnimating) {
                    ...
                    if (hintView.getText().toString().equals("0")) {
                        Toast.makeText(GuessWord.this, getString(R.string.hint_no_chance), Toast.LENGTH_LONG).show();
                        return;
                    }
                    for (int n = 0; n < toTv.size(); n++) {
                        TextView t = toTv.get(n);
                ...
                Toast.makeText(GuessWord.this, getString(R.string.not_in_game), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void showLowBalDiag() {
        if (lowBalDiag == null) lowBalDiag = Misc.lowbalanceDiag(this, new Misc.yesNo() {
            ...
            public void yes() {
                lowBalDiag.dismiss();
                startActivity(new Intent(GuessWord.this, Offers.class));
                finish();
            }
