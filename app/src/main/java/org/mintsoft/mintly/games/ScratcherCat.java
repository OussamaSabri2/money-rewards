    ...
    private void showAskDiag(String title, String id, String cst) {
        ...
        if (askDiag == null) {
            ...
            askDiag.findViewById(R.id.dialog_sc_plus).setOnClickListener(view -> {
                if (bal < cost * qty) {
                    Toast.makeText(ScratcherCat.this, getString(R.string.insufficient_balance), Toast.LENGTH_LONG).show();
                } else {
                    qty += 1;
            ...
            askDiag.findViewById(R.id.dialog_sc_cancel).setOnClickListener(view -> {
                qty = 0;
                diagCostView.setText("0");
                askDiag.dismiss();
            });
            askDiag.findViewById(R.id.dialog_sc_submit).setOnClickListener(view -> {
                if (qty != 0) {
                    askDiag.dismiss();
                    makePurchase();
                }
