...
class chAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (vT == IMG_SENT || vT == IMG_RECEIVED) {
            ...
            if (isBlocked) {
                vh.msgView.setText(context.getString(R.string.blocked_user_msg));
            } else {
                vh.msgView.setText(msg);
            }
    ...
    private void showActions(String uid, String name, String txt) {
        ...
        if (aDiag == null) {
            ...
            aDiag.findViewById(R.id.chat_option_reply).setOnClickListener(view -> {
                aDiag.dismiss();
            ...
            aDiag.findViewById(R.id.chat_option_report).setOnClickListener(view -> {
                aDiag.dismiss();
                new Handler().postDelayed(() -> Toast.makeText(context, context.getString(R.string.user_reported),
        ...
        if (blocked.contains(user_id + "||")) {
            bTxtView.setText(R.string.unblock);
            ...
            bTxtView.setText(R.string.block);
